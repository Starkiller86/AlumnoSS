...
class TemplateProcessor
{
    ...
    {
        foreach ($this->temporaryDocumentHeaders as $index => $headerXML) {
            $this->zipClass->addFromPhpWordString($this->getHeaderName($index), $this->temporaryDocumentHeaders[$index]);
        }

        $this->zipClass->addFromPhpWordString('word/document.xml', $this->temporaryDocumentMainPart);

        foreach ($this->temporaryDocumentFooters as $index => $headerXML) {
            $this->zipClass->addFromPhpWordString($this->getFooterName($index), $this->temporaryDocumentFooters[$index]);
        }
